...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7540f7afb9d8c5ad6cfafdd77a0008cd) *)
(*
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({cs_name = "hypertable"; cs_data = PropList.Data.create (); 
                  },
                   {
                      ...
                      bs_c_sources = ["hypertable_stubs.c"; "cxx_wrapped.h"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true,
                             [
                                ...
                                "-O2";
                                "-Wno-deprecated";
                                "-I/opt/hypertable/current/include"
                             ])
                        ];
                      bs_cclib =
                        [
                 ...
                 ({cs_name = "test"; cs_data = PropList.Data.create (); },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "hypertable"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
          ...
          plugins = [("DevFiles", None); ("META", None)];
